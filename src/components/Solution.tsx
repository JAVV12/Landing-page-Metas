...
export default function Solution() {
  return (
    <section className="py-12 md:py-20 px-4 bg-solution-gradient">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-10 md:mb-16">
          <div className="mb-8 flex justify-center">
            <img src="/images/Alejo.svg" alt="Alejandro Valencia" className="h-64 md:h-80 w-auto" />
          </div>
          ...
          <p className="text-lg md:text-xl leading-relaxed" style={{ color: 'var(--primary)', opacity: 0.8 }}>
            Una donde avanzas con un propósito claro, tomas decisiones con confianza,
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 gap-6 md:gap-8">
          {inputs.desires.map((desire, index) => (
            <div key={index} className="p-6 md:p-8 rounded-lg shadow-lg border-l-4 transform hover:scale-105 transition-all duration-300" style={{ backgroundColor: 'var(--secondary)', borderLeftColor: 'var(--tertiary)' }}>
        ...
        <div className="text-center mt-12">
          <p className="text-lg italic" style={{ color: 'var(--primary)', opacity: 0.7 }}>
            "El crecimiento verdadero comienza desde adentro. Cuando transformas tu relación contigo mismo,
