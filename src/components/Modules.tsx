      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-10 md:mb-16">
          ...
          <div className="mb-8 flex justify-center">
            <img src="/images/CAJA.png" alt="Programa Completo" className="h-[500px] md:h-[760px] w-auto object-contain hover:scale-105 transition-transform duration-300" />
          </div>
        ...
        <div className="space-y-4 md:space-y-6">
          {inputs.modules.map((module, index) => (
            <div key={index} className="p-6 md:p-8 rounded-lg shadow-md border-l-4" style={{ background: 'linear-gradient(90deg, rgba(248, 249, 250, 0.5) 0%, rgba(233, 236, 239, 0.5) 100%)', borderLeftColor: 'var(--tertiary)' }}>
