      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          {inputs.pains.map((pain, index) => (
            <div key={index} className="p-6 md:p-8 rounded-lg shadow-lg border-l-4" style={{ backgroundColor: 'var(--secondary)', borderLeftColor: 'var(--tertiary)' }}>
        ...
        <div className="text-center mt-12">
          <p className="text-lg italic" style={{ color: 'var(--primary)', opacity: 0.7 }}>
            "Cada día que pasa sin una dirección clara, es energía perdida, oportunidades desaprovechadas,
